...
public class ItemRequestControllerTest {
    ...
    @SneakyThrows
    @Test
    void createRequestTest_ifInvalidDto_responseBadRequest() {
        StringBuilder sb = new StringBuilder();
        ItemRequestDto invalidItemRequestDto = testItemRequestDto1;

        invalidItemRequestDto.setDescription("");
        ...
        invalidItemRequestDto.setDescription(sb.toString());
        mvc.perform(post("/requests")
                        .content(mapper.writeValueAsString(invalidItemRequestDto))
                        .header(userIdHeader, 1)
                        .characterEncoding(StandardCharsets.UTF_8)
        ...
        verify(requestService, never()).createRequest(any(), anyLong());
    }
