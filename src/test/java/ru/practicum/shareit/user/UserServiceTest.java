...
public class UserServiceTest {
    ...
    @Test
    void createUserTest_ifValid_returnsUser() {
    ...
    void updateUserTest_ifValid_returnUserDto() {
        ...
        UserDto updatedUser = userService.updateUser(update, update.getId());
    ...
    void updateUserTest_ifEmailConflict_AlreadyExistsException() {
        ...
        assertThrows(AlreadyExistsException.class, () -> userService.updateUser(update, update.getId()));
    }
    ...
    void updateUserTest_ifNoSuchUser_NotFoundException() {
        ...
        assertThrows(NotFoundException.class, () -> userService.updateUser(update, update.getId()));
    }

    @Test
    void getUser_ifExists_returnUser() {
    ...
    @Test
    void getUser_ifNotExists_NotFoundException() {
    ...
    @Test
    void getUsers_ifInvocated_returnsUsersList() {
